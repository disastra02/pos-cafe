...
class RecoveryModel extends \App\Models\BaseModel
{
	...
	public function sendLink()
	{
		...
		if ($insert_token) {
			...
			$email_data = array(
				'from_email' => $email_config->from, 'from_title' => 'Jagowebdev', 'to_email' => $_POST['email'], 'to_name' => $_POST['email'], 'email_subject' => 'Reset Password', 'email_content' => str_replace('{{url}}', $url, email_recovery_content()), 'images' => ['logo_text' => ROOTPATH . 'public/images/logo_text.png']
			);
