		...
		<div class="row">
			<div class="col-sm-12">
				<div class="right-panel-header ps-4 pe-3 rounded-top shadow">
					<div class="title cari-customer"><span class="cari-customer" id="nama-customer">Customer Umum</span></div>

					<button class="btn-clear-info cari-customer rounded-1 me-2 border-0"><i class="fas fa-user-plus"></i></button>
					<button class="btn btn-clear-warning del-customer me-2 rounded-1 border border-0" id="del-customer" style="display:none"><i class="fas fa-times"></i></button>
					<button class="show-mobile-d-flex btn-clear-success show-left-panel rounded-1 me-2 border-0"><i class="fas fa-search"></i></button>
					<button class="btn-clear-primary setting-barang rounded-1 me-2 border-0"><i class="fas fa-cog"></i></button>
					<button class="btn btn-clear-danger del-barang-pilih rounded-1 border border-0"><i class="fas fa-trash-alt"></i></button>
				</div>
			</div>
		</div>
		<div class="row">
					...
					<div class="barang-pilih-empty">
						<div class="alert alert-primary">
							...
							<ul>
								...
								<li>Klik nama disebelah icon <i class="fas fa-user-plus"></i> untuk mengganti nama customer</li>
								<li>Klik icon <i class="fas fa-trash-alt"></i> untuk menghapus semua barang yang sudah dipilih</li>
							</ul>
						</div>
					</div>
					<form id="barang-pilih-form" style="display:none">
						...
						<table id="barang-pilih-tabel" class="tabel-barang-pilih" style="display:none">
										...
										<div class="nama-barang-container">
											...
											<div class="d-flex flex-nowrap align-items-center">
												<div class="input-group" style="width:128px">
													<button type="button" style="width:32px;height:32px;font-size:70%" class="btn btn-clear-warning rounded-start min-jml-barang" disabled="disabled"><i class="fas fa-minus"></i></button>
													<input type="text" size="4" class="rounded-0 form-control text-end qty me-0 ms-0" style="width:42px;height:32px" name="qty[]" value="" />
													<button type="button" style="width:32px;height:32px;font-size:70%" class="btn btn-clear-success rounded-end plus-jml-barang"><i class="fas fa-plus"></i></button>
												</div>
							...
							<tbody>
								...
								<tr class="fw-bold text-primary" style="font-size:110%">
									<td>Total</td>
									<td>Rp</td>
									<td>
